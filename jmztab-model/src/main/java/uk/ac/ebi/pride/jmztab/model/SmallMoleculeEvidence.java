...
/**
 * The small molecule evidence section is table-based. The small molecule evidence section MUST always come after the small molecule section,
 ...
 * @since 09/11/16
 */
public class SmallMoleculeEvidence extends MZTabRecord {
    private Metadata metadata;

    /**
     * Create a small molecule feature record based on structure defined by {@link MZTabColumnFactory}
     *
     * @param factory SHOULD NOT set null.
     * @param metadata SHOULD NOT set null.
     */
    public SmallMoleculeEvidence(MZTabColumnFactory factory, Metadata metadata) {
        super(factory);
        this.metadata = metadata;
    }
    
    //TODO add column data methods
...
//        return getSplitList(SmallMoleculeColumn.IDENTIFIER.getLogicPosition(), String.class);
//    }
//
//    /**
//     * A list of "|" separated possible identifiers for these small molecules. The database identifier
...
//        return getSplitList(SmallMoleculeColumn.SMILES.getLogicPosition(), String.class);
//    }
//
//    /**
//     * The molecules structure in the simplified molecular-input line-entry system (SMILES). If there are more than
...
//        return getSplitList(SmallMoleculeColumn.INCHI.getLogicPosition(), String.class);
//    }
//
//    /**
//     * The standard IUPAC International Chemical Identifier (InChI) Key of the given substance. If there are more than
...
//        setValue(SmallMoleculeColumn.INCHI.getLogicPosition(), parseStringList(BAR, inchiKeyLabel));
//    }
//
//    /**
//     * The standard IUPAC International Chemical Identifier (InChI) Key of the given substance. If there are more than
...
//        setValue(SmallMoleculeColumn.INCHI.getLogicPosition(), inchiKey);
//    }
//
//    /**
...
//    }
    ...
    public String toString() {
        return Section.Small_Molecule_Feature.getPrefix() + TAB + super.toString();
    }
}
