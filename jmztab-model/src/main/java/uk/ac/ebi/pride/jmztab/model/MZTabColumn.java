...
public class MZTabColumn {
    ...
    private String generateLogicalPosition() {
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("%0"+MZTabConstants.ORDER_DIGITS+"d", Integer.parseInt(order)));
        if (id != null) {
     ...
     * element ms_run[2] 's index is 2.
     * 
     * The format is order + id + element.id. The numbers are left padded with zeros. Each segment has at most {@link MZTabConstants#ORDER_DIGITS} digits.
     *
