...
public abstract class MZTabHeaderLineParser extends MZTabLineParser {
    ...
    /**
     * This methods delegates to the subclasses the parsing of the columns. All of the columns are defined in the {@link ProteinColumn}, {@link PeptideColumn}, {@link PSMColumn}
